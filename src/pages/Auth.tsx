...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1A202C] flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background Logo Graphics - Green parts only - Much larger size */}
      ...
      {/* Back Button - Fixed position to stay in viewport */}
      <button
        onClick={() => navigate('/')}
      ...
      <div className="w-full max-w-md relative z-10">
        {/* Logo - Left aligned with proper spacing from top */}
        <div className={`flex items-center mb-8 ${isLogin ? 'mt-8' : 'mt-16'}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Divider */}
          <div className="border-t border-[#6B7280] opacity-30"></div>
