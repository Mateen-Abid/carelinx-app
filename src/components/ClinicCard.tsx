...
const ClinicCard: React.FC<ClinicCardProps> = ({
  ...
  return (
    <article 
      ...
      className="bg-white flex w-full flex-col h-[160px] sm:h-[180px] overflow-hidden items-stretch p-1.5 sm:p-2 mb-2 rounded-[14px] cursor-pointer hover:shadow-lg transition-shadow duration-200"
    >
