...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <article className={`bg-white overflow-hidden flex-1 min-w-[222px] max-w-[222px] px-[18px] py-[23px] rounded-[18px] ${isSpecial ? 'relative' : ''}`}>
      ...
      <div className={`w-full ${isSpecial ? 'mt-7 z-0' : ''}`}>
        <div className="flex w-full flex-col items-center">
          ...
          <div className="flex w-[102px] max-w-full gap-[-76px] mt-3.5">
          ...
          <div className="flex flex-col items-center text-xs font-normal justify-center mt-3.5">
      ...
      <button className="bg-[rgba(14,36,68,1)] flex min-h-[42px] w-full items-center text-sm text-white font-normal text-center tracking-[-0.28px] leading-none justify-center mt-7 px-[18px] py-[13px] rounded-[40px] hover:bg-[rgba(14,36,68,0.9)] transition-colors">
