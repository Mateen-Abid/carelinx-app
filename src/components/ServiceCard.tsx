...
// Comprehensive mapping of service names to database keys
const serviceNameToSlugMap: { [key: string]: string } = {
...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  // Convert service name to URL-friendly ID using mapping or fallback
  const getServiceId = (name: string) => {
    return serviceNameToSlugMap[name] || name.toLowerCase().replace(/[^\w\s-]/g, '').replace(/\s+/g, '-');
  };
